...
class acf_qtranslate_plugin
{
    ...
    public function __construct()
    {
        ...
        add_filter('qtranslate_admin_config', array ($this, 'qtranslate_admin_config'));
     ...
     * @return array
     */
    public function qtranslate_admin_config($config)
    {
        $pages = array (
            //'post.php' => '',
            'admin.php' => 'page=',
        ...
        $show_on_pages = $this->get_plugin_setting('show_on_pages');
